...
> Данный проект публикуется в открытый доступ (open-source) в связи с тем, что владелец хостинг-проектов **Intezio** и **1cent** (ИП Яковлев Денис Александрович) отказался оплачивать разработку данного инструмента Looking Glass.
